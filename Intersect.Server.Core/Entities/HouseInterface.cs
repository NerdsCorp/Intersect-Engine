...
// Placeholder packet classes - these will need to be implemented in the Network/Packets folder
namespace Intersect.Network.Packets.Server
{
    public partial class HousePacket
    {
    ...
    public partial class HouseFurnitureUpdatePacket
    {
...
namespace Intersect.Server.Localization
{
    public partial class Strings
    {
        public static class Houses
        {
            ...
            public static LocalizedString FurnitureRemoved => new LocalizedString(@"Removed {0}.");
        }
    }
}
